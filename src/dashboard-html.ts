...
<div class="flex items-center justify-between mb-1">
  <div class="flex items-center gap-3">
    <h1 class="text-xl font-bold text-white">BT Ops <span style="font-size:13px;font-weight:400;color:#6b7280">Mission Control</span></h1>
...
function cawGoStep2() {
  ...
  document.getElementById('caw-suggested-name').textContent = 'BT Ops ' + label;
